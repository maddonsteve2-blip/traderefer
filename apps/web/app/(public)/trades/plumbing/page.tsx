                    ...
                    <div className="max-w-4xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link
                                ...
                                className="bg-[#FF6600] hover:bg-[#E65C00] text-white font-black px-8 rounded-xl transition-colors inline-flex items-center justify-center"
                ...
                <div className="max-w-6xl mx-auto space-y-16">
                    ...
                    <section className="bg-[#1A1A1A] rounded-3xl p-8 md:p-12 text-center text-white">
                        ...
                        <p className="text-zinc-400 mb-8 max-w-2xl mx-auto" style={{ fontSize: "20px", lineHeight: 1.7 }}>
                            Browse verified local plumbing businesses, compare their services, and move into suburb-level directory pages to find the best fit for your job.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <Link
                                ...
                                style={{ minHeight: "64px", fontSize: "18px" }}
                            >
                                Browse Plumbing Businesses <ArrowRight className="w-5 h-5" />
                            </Link>
                            <Link
                                href="/categories"
