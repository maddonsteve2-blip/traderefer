                        ...
                        <div className="bg-[#1A1A1B] rounded-2xl p-5 text-white relative overflow-hidden shadow-xl">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-1.5 mb-2">
                                    <span className="text-zinc-400 text-[11px] font-semibold uppercase tracking-wider">Rewards by</span>
                                    {/* eslint-disable-next-line @next/next/no-img-element */}
                                ...
                                <p className="text-zinc-300 text-sm font-semibold mb-1 leading-snug">
                                ...
                                <div className="flex flex-wrap gap-1 mb-4">
                                    {["Woolworths", "Bunnings", "Uber", "+400"].map((b) => (
                                        <span key={b} className="text-xs font-semibold bg-white/10 text-zinc-200 px-2 py-0.5 rounded-full">{b}</span>
                                    ))}
                                </div>
                                <Link href="/dashboard/referrer/withdraw"
                                    className="block w-full text-center bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-bold text-sm py-2.5 transition-colors mb-2">
                                    View My Rewards
                                </Link>
                                <Link href="/rewards"
                                    className="block w-full text-center text-zinc-400 hover:text-white text-sm font-semibold py-1 transition-colors underline underline-offset-2">
                                    See all 335 brands →
                                </Link>
                            </div>
                        </div>
