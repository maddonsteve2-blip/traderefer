    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-6">
                ...
                {showQR && (
                    <div className="mt-8 flex flex-col items-center gap-8 p-12 bg-white border-2 border-zinc-100 rounded-[48px] shadow-2xl animate-in fade-in zoom-in-95 duration-500 text-center">
                        <div ref={qrRef} className="bg-white p-10 rounded-[48px] border-2 border-zinc-50 shadow-2xl shadow-zinc-200/50">
