...
async def get_social_feed(
    ...
    try:
        ...
        logger.warning(f"Social feed: badge query failed: {e}")
    ...
    try:
        ...
        logger.warning(f"Social feed: signup query failed: {e}")
    ...
    try:
        ...
        logger.warning(f"Social feed: prezzee query failed: {e}")
    ...
    try:
        ...
        logger.warning(f"Social feed: leads query failed: {e}")
    ...
    try:
        ...
        logger.warning(f"Social feed: partnership query failed: {e}")
